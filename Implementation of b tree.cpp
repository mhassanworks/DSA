...
public:
    ...
    // of y in the child array C[]. The Child y must be full when this
    // function is called
    ...
    // Make BTree a friend so that we can access private members of this
...
// A utility function to traverse all nodes in a subtree rooted
// with this node
